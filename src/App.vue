...
<h1>Welcome to the Nanopass Clout election!</h1>
      <h4>Click to vote on this very important issue.</h4>
      <h4>You can vote as many times as you like. Click away!</h4>
<b-row align-h="center" class="mt-5">
      <b-card-group deck>
        <b-card bg-variant="success" text-variant="white" header="Vote iamAbsinthe" class="text-center" footer-tag="footer">
          <b-card-text>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b-card-text>
          <b-button size="lg" variant="primary"  @click="vote('yes')">Button</b-button>
          <em slot="footer">{{ votesYes }} voted</em>
        </b-card>
<b-card bg-variant="danger" text-variant="white" header="Vote Rei" class="text-center" footer-tag="footer">
          <b-card-text>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b-card-text>
    ...
    <b-row align-h="center" class="mt-5">
      <p>Questions? Ask Crypt0D4d <a href="https://twitter.com/crypt0d4d">@Crypt0D4d</a>.</p>
    </b-row>
  </div>  
</template>
